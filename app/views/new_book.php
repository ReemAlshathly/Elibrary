  ...
  <form class="card-body" action="/save_book" method="POST">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <input name="price" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">pages_number</label>
        <input name="pages_number" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">publisher_id</label>
        <input name="publisher_id" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">author_id</label>
        <input name="author_id" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">category_id</label>
        <div class="input-group input-group-merge">
            
          <input  name="category_id"type="text" id="multicol-email" class="form-control" placeholder="john.doe" aria-label="john.doe" aria-describedby="multicol-email2" />
        </div>
        <div class="input-group input-group-merge">
        <label class="form-label" for="multicol-email">quantity</label>
          <input  name="quantity"type="text" id="multicol-email" class="form-control" placeholder="john.doe" aria-label="john.doe" aria-describedby="multicol-email2" />
        </div>
        <div class="input-group input-group-merge">
        <label class="form-label" for="multicol-email">format</label>

          <input  name="format"type="text" id="multicol-email" class="form-control" placeholder="john.doe" aria-label="john.doe" aria-describedby="multicol-email2" />
          <span class="input-group-text" id="multicol-email2">format</span>
        </div>
        <div class="input-group input-group-merge">
        <label class="form-label" for="multicol-email">created_by</label>

          <input  name="created_by"type="text" id="multicol-email" class="form-control" placeholder="john.doe" aria-label="john.doe" aria-describedby="multicol-email2" />
