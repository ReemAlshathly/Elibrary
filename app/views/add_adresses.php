...
<div class="card mb-4">
  <h5 class="card-header">انشاء طلب جديد</h5>
  <form class="card-body" action="/save_order" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">المجموع </label>
        <div class="input-group input-group-merge">
          <input  name="total" type="text"  class="form-control"  aria-describedby="multicol-email2" />
          
        </div>
        

      </div> <div class="col-md-6">
        <label class="form-label" for="multicol-email"> التخفيض </label>
        <div class="input-group input-group-merge">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-email"> طريقة الدفع  </label>
        <div class="input-group input-group-merge">
          <input  name="payment_method" type="text"  class="form-control"  aria-describedby="multicol-email2" />
          </div>

        </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email"> صافي المجموع  </label>
        <div class="input-group input-group-merge">
          <input  name="net_total" type="text"  class="form-control"  aria-describedby="multicol-email2" />
        ...
        <div class="input-group input-group-merge">
          <input  name="address_id" type="text"  class="form-control"  aria-describedby="multicol-email2" />
