...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_offer" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الخصم </label>
        <input name="discount" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>

      <div class="col-md-6">
        <label class="form-label" for="multicol-email">تأريخ البدء </label>
        ...
        <label class="form-label" for="multicol-email">تأريخ الانتهاء </label>
        <div class="input-group input-group-merge">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">رقم الكتاب  </label>
        <div class="input-group input-group-merge">
          <input  name="book_ids" type="text"  class="form-control"  aria-describedby="multicol-email2" />
          
        </div>
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-confirm-password">تفعيل العرض</label>
          <div class="input-group input-group-merge">
          <label class="switch">
