...
<div class="card mb-4">
  <h5 class="card-header"> مدينة جديدة</h5>
  <form class="card-body" action="/save_citeis" method="POST" enctype="multipart/form-data">
    
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">اسم المدينة</label>
        <input name="citeis_name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
